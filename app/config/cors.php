...
return array(
    ...
    'paths' => array(
        'cars/affiliate-*' => array(
            'allowedOrigins' => array('*'),
            'allowedHeaders' => array('*'),
            'allowedMethods' => array('POST','OPTIONS'),
            'maxAge' => 3600,
        ),
        'scheduled/cjproductpost' => array(
            'allowedOrigins' => array('*'),
            'allowedHeaders' => array('*'),
            'allowedMethods' => array('POST','OPTIONS'),
            'maxAge' => 3600,
        ),
        'api/v2/vehicle-model/get-new-by-make' => array(
            'allowedOrigins' => array('*'),
            'allowedHeaders' => array('*'),
            'allowedMethods' => array('GET','OPTIONS'),
            'maxAge' => 3600,
        ),
        'api/v2/vehicle-style/new-auto-quote-dealers' => array(
            'allowedOrigins' => array('*'),
            'allowedHeaders' => array('*'),
            'allowedMethods' => array('GET','OPTIONS'),
            'maxAge' => 3600,
