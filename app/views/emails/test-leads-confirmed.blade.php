      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td style="color: #333;font-family: sans-serif;font-size: 16px;line-height: 22px">
              ...
              <br>
              <br>
              {{$merchant['display']}} has received their test lead(s) and is ready to be launched live. We will reach out to you when their order is ready. 
              <br>
              <br>
              Have a great day!
            </td>
