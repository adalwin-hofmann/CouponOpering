    ...
    <table width="200" align="left" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="133" style="padding: 0 20px 20px 0;">
          <img class="fix" src="{{$image ? $image->path : ''}}" width="200" height="133" border="0" alt="" style="height: auto" />
        </td>
      </tr>
    </table>
    <!--[if (gte mso 9)|(IE)]>
            ...
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy" style="color: #333;font-family: sans-serif;font-size: 16px;line-height: 22px">
                      <strong style="font-size: 20px">{{$vehicle->year.' '.$vehicle->make_name.' '.$vehicle->model_name}}</strong><br />
                      {{$incentives ? $incentives[0]->name : ($vehicle->price == 0 ? $vehicle->price : '')}}
                    </td>
                  </tr>
                  <!-- Coupon Button Start -->
                  <tr>
                      ...
                      <table class="buttonwrapper" bgcolor="#1f9f5f" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button coupon" height="45" style="text-align: center;font-size: 18px;font-family: sans-serif;font-weight: bold;padding: 0 30px 0 30px">
                            <a href="{{URL::abs('/cars/research/'.$vehicle->make_slug.'/'.$vehicle->model_slug.'?tm=email&share='.Auth::user()->id)}}" style="color: #fff;text-decoration: none">View Vehicle »</a>
                          </td>
                        </tr>
                      </table>
                    </td>
