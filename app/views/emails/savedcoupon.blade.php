      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="h2" style="color: #333;font-family: sans-serif;padding: 0 0 15px 0;margin-bottom: 0;font-size: 24px;line-height: 28px;font-weight: bold">
            Your saved coupons are about to expire
          </td>
        </tr>
        <tr>
          <td class="bodycopy" style="color: #333;font-family: sans-serif;font-size: 16px;line-height: 22px">
            Hello, _______
            <br><br>
            We noticed that some of the coupons that you have saved are getting ready to expire. We wanted to send you this friendly reminder so that you don't miss out on an opportunity to use them before it's too late!
          </td>
        </tr>
            ...
            <table class="buttonwrapper" bgcolor="#1f9f5f" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="button generic" height="45" style="text-align: center;font-size: 18px;font-family: sans-serif;font-weight: bold;padding: 0 30px 0 30px">
                  <a href="#" style="color: #fff;text-decoration: none">View Your Saved Coupons »</a>
                </td>
              </tr>
            </table>
          </td>
