...
<script>
    ...
    HomeControl = can.Control(
    {
        init: function()
        {
            ...
            hash && $('.merchant-nav .hidden-xs a[href="' + hash + '"]').tab('show').addClass('btn-black').removeClass('btn-white');
            hash && $('.merchant-nav .merchant-menu a[href="' + hash + '"]').parent().addClass('active');
            if (hash != "") {
                $('.merchant-nav .hidden-xs a[href!="' + hash + '"]').removeClass('btn-black').addClass('btn-white');
                $('.merchant-nav .merchant-menu a[href!="' + hash + '"]').parent().removeClass('active');
            }
            ...
            if (is_dealer == '1')
            {
                ...
                //$('a[href="#newCars"]').tab('show');
                if ((hash == '#newCars') || (hash == '#usedCars') || (hash == '#autoServices'))
                {
                    $('.merchant-nav .hidden-xs a[href="#offers"]').tab('show').addClass('btn-black').removeClass('btn-white');
                    $('.merchant-nav .merchant-menu a[href="#offers"]').parent().addClass('active');
                ...
                /*if (hash == '') {
                    $('.dealer-menu a.btn[href="#newCars"]').removeClass('btn-green').addClass('btn-white');
                    $('.dealer-menu a.btn[href="#autoServices"]').removeClass('btn-green').addClass('btn-white');
                    if(used_car_leads)
                    {
                        $('.dealer-menu a.btn[href="#usedCars"]').tab('show').removeClass('btn-white').addClass('btn-green');
                    }
                    else if(new_car_leads)
                    {
                        $('.dealer-menu a.btn[href="#newCars"]').tab('show').removeClass('btn-white').addClass('btn-green');
                    }
                    else
                    {
                        $('.dealer-menu a.btn[href="#autoServices"]').tab('show').removeClass('btn-white').addClass('btn-green');
        ...
        {
            $('.merchant-menu a.btn.btn-black').removeClass('btn-black').addClass('btn-white');
            $('.merchant-menu a[href="#about"]').removeClass('btn-white').addClass('btn-black');
            $('.footer').ScrollTo();
        ...
        '.merchant-menu a click': function(element, event)
        {
            ...
            $('.merchant-menu a').removeClass('btn-black').addClass('btn-white');
            $('.merchant-menu a[href='+hash+']').removeClass('btn-white').addClass('btn-black');
        ...
        '.js-masonry .item a click': function(element, event)
        {
            ...
            if((element).parent().hasClass('category-links')) return;
