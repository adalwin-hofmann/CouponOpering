...
@section('sidebar')
	...
	<div class="panel panel-default explore-sidebar">
	    <div class="panel-heading">
	      <span class="h4 block panel-title">
...
<div class = "content-bg">
		...
		<p> Can't find the merchant you're looking for? Please complete the form below.</p>
		<div id="suggest-merchant">
			<form role="form">
					...
					<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<select name = "State" class = "form-control">
								<option selected value = "State">Please select one...</option>
				...
				<button type="button" class="btn btn-lg btn-black">Submit</button>
			</form>
			<div class="clearfix"></div>
			<hr class="dark">
		</div>
