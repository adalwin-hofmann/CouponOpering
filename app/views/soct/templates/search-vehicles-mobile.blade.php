...
<div class="panel panel-default search-vehicles-mobile">
    <div class="panel-heading">
      <span class="h4 hblock panel-title">
        <a data-toggle="collapse" class="{{(isset($panelOpen) && $panelOpen)?'':'collapsed'}}" href="#collapseSearchVehiclesMobile">Search Makes/Models<span class="glyphicon glyphicon-minus-sign pull-right"></span><span class="glyphicon glyphicon-plus-sign pull-right"></span></a>
        <div class="clearfix"></div>
      </span>
    </div>
    <div id="collapseSearchVehiclesMobile" class="panel-collapse collapse {{(isset($panelOpen) && $panelOpen)?'in':''}}">
        <div class="panel-body">
           <form role="form" action="/cars/vehicle-search" method="post">
                <div class="form-group row">
                    <div class="col-xs-6">
                        <div class="radio margin-top-0">
                            <label>
                                <input type="radio" name="carType" class="radioCarTypeMobile" value="new" checked="checked">
                                New
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6">
                        <div class="radio margin-top-0">
                            <label>
                                <input type="radio" name="carType" class="radioCarTypeMobile" value="used">
                                Used
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <select class="form-control" id="filterBodyTypeMobile" name="filterBodyType" style="">
                ...
                <div class="form-group">
                    <select class="form-control" id="filterYearMobile" name="filterYear">
                ...
                <div class="form-group">
                    <select class="form-control" id="filterMakeMobile" name="filterMake">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{isset($search_make) && $search_make || !isset($search_make) == 'all'? 'disabled' : ''}}" id="filterModelMobile" name="filterModel" {{isset($search_make) && $search_make == 'all' || !isset($search_make)? 'disabled="disabled"' : ''}}>
                ...
                <div class="form-group">
                    <select class="form-control" id="filterDistanceMobile" name="filterDistance">
